...
\begin{figure}[!t]
\centering{}
\includegraphics[width=2.5in]{augment_examples}
\caption{Examples of augmentations applied to patches of 224 by 224 pixels. (a) The original image. (b) Augmented versions of this image. Note the slight shift in hue and saturation for some of the images.}
\label{fig_augment}
\end{figure}
